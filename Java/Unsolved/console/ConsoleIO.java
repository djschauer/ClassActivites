...
public class ConsoleIO {
  ...
  public static void main(String[] args) {
     ...
     *
     *************************************************************************/
    ArrayList<HashMap<String, String>> strudentList = new ArrayList<>();

    HashMap<String, String> student = new HashMap<>();
    student.put("first, David");
    student.put("last, David");
    student.put("middle, David");
    student.put("email, David");
    student.put("phone, David");
    student.put("address, David");

    studentList.add(student);

    for(HashMap<String, String> stu : studentList) {
      stu.get("first");
    }
